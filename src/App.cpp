...
#include "Visualization/sdlutil.h"
#include <thread>
...
int main()
{
	...
	sourceInfo.url = "E ve - Yuseiboushi.mp3";
	...
	visualizerInfo.imageURL = "Lake.jpg";
	visualizerInfo.intensityOffset = 0.6f;
