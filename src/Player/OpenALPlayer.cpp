...
void OpenALPlayer::playSamples(std::unique_ptr<SampleContainer> container)
{
...
void OpenALPlayer::finalizeConverterInfo(ConverterInitInfo & converterInfo)
{
	...
	if (converterInfo.inChannelCount == 1 || converterInfo.inChannelLayout == 0)
	{
		switch (inFormat)
		{
	...
	else if (converterInfo.inChannelCount == 2)
	{
		switch (inFormat)
		{
		case AV_SAMPLE_FMT_U8:
	...
	else if (converterInfo.inChannelCount == 4) {
		switch (inFormat)
		{
		case AV_SAMPLE_FMT_U8:
	...
	else if (converterInfo.inChannelCount == 6) {
		switch (inFormat)
		{
		case AV_SAMPLE_FMT_U8:
	...
	else if (converterInfo.inChannelCount == 7) {
		switch (inFormat)
		{
		case AV_SAMPLE_FMT_U8:
	...
	else if (converterInfo.inChannelCount == 8) {
		switch (inFormat)
		{
		case AV_SAMPLE_FMT_U8:
